import{_ as Ve}from"./plugin-vue_export-helper.21dcd24c.js";import{i as pe,p as ge,c as B,o as me,a as xe,b as y,d as G,u as ye,t as Ne,r as M,n as Oe,h as r,e as f,f as je,g as Ce,j as ie,k as m,l as c,m as se,q as Le,s as K,v as We,w as Ge,x as Ke,y as t,z as L,A as we,N as qe,B as Ae,C as Qe,D as Ye,I as Je,S as Ue,W as Xe,E as Ze,F as eo,G as oo,H as ue,J as fe,K as ro,L as to}from"./index.a7ae6c65.js";import{u as no,c as be,r as he,i as io,a as so}from"./use-rtl.03dda32a.js";const ve=xe("n-form-item");function lo(e,{defaultSize:d="medium",mergedSize:a,mergedDisabled:s}={}){const n=pe(ve,null);ge(ve,null);const w=B(a?()=>a(n):()=>{const{size:x}=e;if(x)return x;if(n){const{mergedSize:k}=n;if(k.value!==void 0)return k.value}return d}),C=B(s?()=>s(n):()=>{const{disabled:x}=e;return x!==void 0?x:n?n.disabled.value:!1}),$=B(()=>{const{status:x}=e;return x||(n==null?void 0:n.mergedValidationStatus.value)});return me(()=>{n&&n.restoreValidation()}),{mergedSizeRef:w,mergedDisabledRef:C,mergedStatusRef:$,nTriggerFormBlur(){n&&n.handleContentBlur()},nTriggerFormChange(){n&&n.handleContentChange()},nTriggerFormFocus(){n&&n.handleContentFocus()},nTriggerFormInput(){n&&n.handleContentInput()}}}var ao=y("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
